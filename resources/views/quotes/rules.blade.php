<form id="rules_form" action="#">
    ...
    <div class="rules">
        <button type="button" class="rules__nullifier" data-source="quotes" id="rules_nullifier">Ҳама</button>
        ...
        <div class="search rules__search">
            ...
            <input class="search__input rules__search-input" value="{{$keyword}}" placeholder="Вожаи ҷустуҷӯро ворид кунед" type="text" name="keyword" id="rules_keyword" data-source="quotes">
        </div>
