...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //categories
        $categories = ['Ценности и Цели', 'Смысл жизни и Счастье', 'Любовь к жизни', 'Развитие личности', 'Достижения', 'Мораль', 'Мировоззрение', 'Эрудиция', 'Компетентность', 'Самоконтроль', 'Окружение и Общение', 'Способности', 'Предостережение', 'Здоровый образ жизни', 'Общество', 'Образование', 'Наставничество', 'Популяризация науки', 'Оптимизм', 'Творчество', 'Технология', 'Управленческие навыки', 'Предпринимательство', 'Человечество', 'Наука и Философия', 'Вселенная и Бытие', 'Интеллект и Сознание', 'История жизни на Земле', 'Футурология', 'Юмор и Ирония'];
